...
public class VersionMessage extends Message {
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        try {
            ...
            myAddr = new PeerAddress(InetAddress.getByAddress(localhost), params.getPort(), CoinDefinition.INIT_PROTO_VERSION);
            theirAddr = new PeerAddress(InetAddress.getByAddress(localhost), params.getPort(), CoinDefinition.INIT_PROTO_VERSION);
    ...
    public void parse() throws ProtocolException {
        ...
        myAddr = new PeerAddress(params, payload, cursor, CoinDefinition.INIT_PROTO_VERSION);
        cursor += myAddr.getMessageSize();
        theirAddr = new PeerAddress(params, payload, cursor, CoinDefinition.INIT_PROTO_VERSION);
